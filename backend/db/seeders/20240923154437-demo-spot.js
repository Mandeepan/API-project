...
module.exports = {
  async up (queryInterface, Sequelize) {
    await Spot.bulkCreate([
      { ownerId: 1, address: '123 Elm St', city: 'Chicago', state: 'Illinois', country: 'United States', lat: 41.878113, lng: -87.629799, name: 'Downtown Loft', price: 300000.00, description: 'Beautiful loft in the heart of downtown Chicago.' },
  { ownerId: 2, address: '456 Maple Ave', city: 'Austin', state: 'Texas', country: 'United States', lat: 30.267153, lng: -97.743057, name: 'Cozy Cottage', price: 200000.00, description: 'A cozy cottage with a lovely garden.' },
  ...
  { ownerId: 7, address: 'Victoria Harbour', city: 'Hong Kong', state: 'Hong Kong Island', country: 'Hong Kong', lat: 22.28552, lng: 114.15769, name: 'Harbour View Condo', price: 1200000.00, description: 'A luxurious condo with a view of Victoria Harbour.' },
  ...
  { ownerId: 10, address: 'Red Square', city: 'Moscow', state: 'Moscow', country: 'Russia', lat: 55.7558, lng: 37.6176, name: 'Kremlin Apartment', price: 1300000.00, description: 'An apartment near Red Square with historic views.' },
  ...
  { ownerId: 2, address: 'Piazza del Duomo', city: 'Milan', state: 'Lombardy', country: 'Italy', lat: 45.4642, lng: 9.1900, name: 'Cathedral View Flat', price: 1400000.00, description: 'A luxurious flat with a view of the Milan Cathedral.' },
  ...
  { ownerId: 6, address: '10 Nevsky Ave', city: 'St Petersburg', state: 'St Petersburg', country: 'Russia', lat: 59.9343, lng: 30.3351, name: 'St Petersburg Loft', price: 850000.00, description: 'A loft in the cultural heart of St Petersburg.' },
    ], { validate: true });
  },
